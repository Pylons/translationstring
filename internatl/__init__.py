...
class TranslationStringFactory(object):
    ...
    :class:`internatl.TranslationString` objects generated by
...
class ChameleonTranslate(object):
    """ Register as a Chameleon temlpate 'translate' function to allow
    our translator to drive template translation.  The ``translator``
    passsed to this class' constructor should be capable of accepting
    a :term:`translation string` and returning a completely
    interpolated and translated Unicode string."""
